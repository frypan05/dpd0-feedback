...
export default function Navbar({ field, unacknowledgedCount = 0, userEmail = "" }) {
  const displayName = formatEmailName(userEmail)
          ...
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center gap-3">
              {unacknowledgedCount > 0 && (
                <Badge variant="destructive" className="bg-[#7AE2CF] text-white">
            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-sm text-slate-600">
                  Provide structured feedback, {displayName}
                </p>
              </div>
            </div>
          </div>
